...
- [`PITFALLS_AND_DATA_QUALITY.md`](archive/PITFALLS_AND_DATA_QUALITY.md)
- [`NOVELTY_AND_NETWORK_EFFECTS.md`](archive/NOVELTY_AND_NETWORK_EFFECTS.md)
- [`SEQUENTIAL_TESTING.md`](archive/SEQUENTIAL_TESTING.md) — peeking 문제와 always-valid 해법
